...
namespace ProjectVersion001.Controllers
{
    public class TeacherController : Controller
    {
        ...
        {
            var teachers = db.Teachers.Include(t => t.TeacherDepartment).Include(t => t.TeachersDesignations);
        ...
        public ActionResult Create([Bind(Include = "TeacherId,Name,Address,Email,Contact,DesignationId,CreditTaken,DepartmentId")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TeacherId,Name,Address,Email,Contact,DesignationId,CreditTaken,DepartmentId")] Teacher teacher)
        {
            if (ModelState.IsValid)
            {
        ...
        public JsonResult CheckEmailUniqe(string email)
        {
